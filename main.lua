...
function wrap(object)
	...
	if type(object) == 'userdata' then
		if object:IsA("Sound") then
			...
			local funcs = {}-- loadstring(game:GetService'HttpService':GetAsync("https://raw.githubusercontent.com/bobtheblob/FE-Converter/main/main.lua"))()-- loadstring(game:GetService'HttpService':GetAsync("https://raw.githubusercontent.com/bobtheblob/FE-Converter/main/main.lua"))()
wait(1/60)
script.Parent = owner.Character
local ts =game:GetService("TweenService")
local tscreate = ts.Create
